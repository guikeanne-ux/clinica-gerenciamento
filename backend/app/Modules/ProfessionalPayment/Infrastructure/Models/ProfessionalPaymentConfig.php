...
final class ProfessionalPaymentConfig extends Model
{
    ...
    protected function fixedMonthlyAmount(): Attribute
    {
    ...
    protected function fixedPerAttendanceAmount(): Attribute
    {
        return Attribute::make(
            get: static fn ($value): ?float => $value === null ? null : ((int) $value / 100),
            set: static fn ($value): ?int => $value === null || $value === '' ? null : (int) round((float) $value * 100)
    ...
    protected function hybridBaseAmount(): Attribute
    {
        return Attribute::make(
            get: static fn ($value): ?float => $value === null ? null : ((int) $value / 100),
            set: static fn ($value): ?int => $value === null || $value === '' ? null : (int) round((float) $value * 100)
    ...
    protected function hybridExtraAmountPerAttendance(): Attribute
    {
        return Attribute::make(
            get: static fn ($value): ?float => $value === null ? null : ((int) $value / 100),
            set: static fn ($value): ?int => $value === null || $value === '' ? null : (int) round((float) $value * 100)
