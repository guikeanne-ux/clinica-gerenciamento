...
final class MarkAttendanceAsNoShowService
{
    ...
    public function execute(string $attendanceUuid, User $authUser): Attendance
    {
        ...
        $this->support->assertCanSetStatus($attendance, 'falta');
        ...
        $this->audit->log('attendance.no_show', (string) $authUser->uuid, ['attendance_uuid' => $attendance->uuid]);
