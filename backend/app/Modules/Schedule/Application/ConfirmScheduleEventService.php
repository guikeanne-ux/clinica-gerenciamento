...
final class ConfirmScheduleEventService
{
    ...
    public function execute(string $eventUuid, string $actorUserUuid): ScheduleEvent
    {
        ...
        if ($event->status === 'cancelado') {
            throw new BusinessRuleException('Evento cancelado não pode ser confirmado.');
        }
        ...
        $this->audit->log('schedule.events.confirmed', $actorUserUuid, ['event_uuid' => $event->uuid]);
