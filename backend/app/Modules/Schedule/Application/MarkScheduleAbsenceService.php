...
final class MarkScheduleAbsenceService
{
    ...
    public function execute(string $eventUuid, string $actorUserUuid): ScheduleEvent
    {
        ...
        if ($event->status === 'cancelado') {
            throw new BusinessRuleException('Evento cancelado não pode ser marcado como falta.');
        }
        ...
        $this->audit->log('schedule.events.absence_marked', $actorUserUuid, ['event_uuid' => $event->uuid]);
